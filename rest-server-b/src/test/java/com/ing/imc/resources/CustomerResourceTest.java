...
public class CustomerResourceTest {
    ...
    public void testSimpleAccount() throws Exception {
        when(ACCOUNT_SERVICE.getAccountsOf(eq("1"))).thenReturn(Arrays.asList(
                new Account("id1", "accountNumber1", "EUR", BigDecimal.TEN, "ownerId", AccountType.CURRENT, new BigDecimal(50)),
                new Account("id2", "accountNumber2", "EUR", BigDecimal.TEN, "ownerId", AccountType.SAVINGS, null),
                new Account("id3", "accountNumber3", "EUR", BigDecimal.TEN, "ownerId", AccountType.TRADING, null)
                ));
        MvcResult mvcResult = mvc.perform(get("/customer/1/accounts")
                ...
                .andExpect(jsonPath("payload[0].limit").value("50"))
                .andReturn();
